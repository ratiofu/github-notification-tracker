...
- CRITICAL: Always record new learnings first; general learnings in AGENTS.md, implementation-specific learning in docs/plan.md
...
- Source Layout:
  ...
  - `test/` or colocated `*.test.ts` files for Vitest tests.
